...
namespace ArabComputersTask.API.Controllers
{
    public class ReservationsController : ApiController
    {
        ...
        // GET: api/Reservations/5
        [Route("api/CurrentReservation/{roomid}")]
        [ResponseType(typeof(Reservation))]
        public IHttpActionResult GetCurrentReservation(int roomid)
        {
            Reservation reservation = db.Reservations.Where(e=>e.RoomID == roomid && e.CheckoutTime == null).FirstOrDefault();
            if (reservation == null)
            {
                return NotFound();
            }
